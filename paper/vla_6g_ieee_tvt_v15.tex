...
\title{Distilling Evolutionary Optimization into Compact Language Models for Real-Time UAV Relay Positioning in Low-Altitude Vehicular THz Networks}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author_photo.jpg}}]{Abdul~Manan Khan}
