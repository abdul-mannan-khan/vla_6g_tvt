...
Fig.~\ref{fig:efficiency} demonstrates the sample efficiency advantage quantified in Theorem~\ref{thm:warmstart}. Compared to baseline RL algorithms, SGAC provides:
\begin{itemize}
...
\caption{Sample efficiency: percentage of final performance vs. training episodes. SGAC (red) achieves 95\% performance with 4$\times$ fewer samples than baseline RL methods.}
