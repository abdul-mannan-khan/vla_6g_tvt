...
\item We conduct extensive experiments across 50 urban IoT scenarios demonstrating rapid convergence within 500 episodes, with zero violations of the performance floor guarantee throughout training and evaluation.
\end{itemize}
...
Floor guarantee violations & 0/50 & Thm.~\ref{thm:floor} \\
...
Experimental evaluation across 50 urban IoT deployment scenarios demonstrated that SGAC achieves aggregate throughput of 5960~Mbps, representing improvements of 18\% over random placement, 7.7\% over analytical heuristics, and 1.6\% over the SCA baseline. The deterministic performance floor mechanism ensured zero violations throughout training and evaluation, confirming that learned corrections consistently improve upon rather than degrade the analytical solution.
